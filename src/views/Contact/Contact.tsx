...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="min-h-90vh container mx-auto px-4 py-8 md:py-16 flex items-center justify-center">
      <h2 className="sr-only">Contact</h2>
      <div className="max-w-3xl w-full">
        <div className="text-center mb-8">
          <div className="flex justify-center">
            <svg aria-hidden="true" focusable="false" width="150" height="150" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
