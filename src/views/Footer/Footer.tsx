...
useEffect(() => {
  ...
  gsap.fromTo(
    lettersRef.current,
    {
      ...
      scaleY: 1.8,
      scaleX: 0.85,
      transformOrigin: '50% 100%', // clave para alineación
    },
    {
      opacity: 0.15,
      yPercent: 0,
      scaleY: 1,
      scaleX: 1,
      ease: 'power3.out', // 👈 más fluido con scroll
      stagger: {
        each: 0.2,
        from: 'start',
      },
  ...
  return (
    <footer ref={containerRef} className={'h-60 md:h-1/5 relative bg-bg-primary overflow-hidden'}>
      ...
      <div className="relative flex flex-col items-center justify-center z-10 gap-2 py-2">
        <p className="font-sans text-text-primary text-sm font-medium">
          © 2026 Jose Centeno. All Rights Reserved.
        </p>
      ...
      <div className="w-full flex justify-center items-end pointer-events-none leading-none">
        <span
          ref={addToRefs}
          style={{
            color: 'transparent',
            ...
            fontSize: 'clamp(10px, 30vw, 360px)',
