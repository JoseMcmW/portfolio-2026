...
const GlassIcons: React.FC<GlassIconsProps> = ({ items, className, vertical = false }) => {
  ...
  return (
    <div className={`${vertical ? 'flex flex-col gap-8' : 'grid gap-[5em] grid-cols-2 md:grid-cols-3'} mx-auto py-[3em] overflow-visible ${className || ''}`}>
