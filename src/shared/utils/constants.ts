...
// Social media links (centralized for reuse in home and footer)
export const socialLinks = [
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/josemcentenoc/',
    icon: 'linkedin',
...
export const footerInfo = {
  copyright: '© 2026 Jose Centeno. All Rights Reserved.',
...
// File size limits (if needed for future file uploads)
