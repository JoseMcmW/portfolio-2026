...
export const LaserFlow: React.FC<Props> = ({
  ...
  useEffect(() => {
    ...
    const renderer = new THREE.WebGLRenderer({
      antialias: false,
      alpha: true, // ← Habilitamos transparencia
      depth: false,
      stencil: false,
      powerPreference: 'high-performance',
      premultipliedAlpha: true, // ← Para mejor blending
    ...
    renderer.setClearColor(0x000000, 0); // ← Fondo transparente (alpha = 0)
    ...
    const material = new THREE.RawShaderMaterial({
      ...
      depthTest: false,
      depthWrite: false,
      blending: THREE.AdditiveBlending // ← Blending aditivo para efecto de luz
    });
    ...
    // Escuchar mouse en todo el documento para que funcione aunque el canvas no capture eventos
